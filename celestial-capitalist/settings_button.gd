...
@onready var enterDelay = get_node("../Timers/settingsDelay")
@onready var paddingSize = Vector2(6.103, 1.492)
...
func _process(delta):
	...
	if movement == true:
		position = position.lerp(Vector2(1000,525), delta*moveSpeed)
